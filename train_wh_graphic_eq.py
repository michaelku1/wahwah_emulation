...
# from models.processors.trainable_graphic_eq import TrainableGraphicEQ
from models.processors.helmut_keller import helmut_keller_processor_batch
...
train_input_paths_clean = "/Users/michael/Desktop/guitar data/EGDB subset/train"
train_input_paths_wet = "./fx_data/NA_wah_75/mono/NA_WahFilter_7.5_Power_True_Bypass_False"
# train_input_paths_wet = "./fx_data/NA_wah_75/poly/NA_WahFilter_7.5_Power_True_Bypass_False"
valid_input_paths_clean = "./seen/EGDB_DI_valid_dry"
valid_input_paths_wet = "./seen/EGDB_DI_valid_wet"
...
wahwah = wah_wah(sr, processor_fn=helmut_keller_processor_batch)
num_taps = 1025
window_size = 256

# check processing function type
print(wahwah.process_fn)
...
trainable_graphic_eq_pre = TrainableGraphicEQ(num_taps, window_size=window_size, fs=44100) # pre-emphasis filter
trainable_graphic_eq_post = TrainableGraphicEQ(num_taps, window_size=window_size, fs=44100)# post-emphasis filter
